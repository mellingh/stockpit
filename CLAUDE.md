...
- Analyse-Layout (Runde 13, Yahoo-Stil): `.chart-row` = Chart links + 330px-Seitenspalte `.chart-aside` rechts mit **Technik-Panel** und **"Meinungen auf X"** (war Micha unten zu versteckt). Darunter: Quote-Strip, Übersicht, Grid (Analysten | Kennzahlen, Ratings volle Breite), News. Das "Accounts verwalten"-Akkordeon der X-Karte bleibt nach Hinzufügen/Entfernen OFFEN (`renderX(a, true)`).
